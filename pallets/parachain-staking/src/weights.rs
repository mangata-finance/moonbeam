...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn active_session_change(x: u32, y: u32, z: u32, w: u32, ) -> Weight {
		Weight::from_parts(470_042_000, 0)
			// Standard Error: 1_684_000
			.saturating_add((Weight::from_parts(23_366_000, 0)).saturating_mul(x as u64))
			// Standard Error: 4_024_000
			.saturating_add((Weight::from_parts(139_318_000, 0)).saturating_mul(y as u64))
			// Standard Error: 23_684_000
			.saturating_add((Weight::from_parts(761_880_000, 0)).saturating_mul(z as u64))
			// Standard Error: 12_287_000
			.saturating_add((Weight::from_parts(470_042_000, 0)).saturating_mul(w as u64))
